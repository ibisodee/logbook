                                      ...
                                      <div class="modal-dialog" role="document" id="standardModalLabel">
                                        <div class="modal-content">
                                          <div class="modal-body text-center">
                                            ...
                                            @endif
                                            <form class="mt-0" action="{{url('/add-pressurelines')}}" method="post">
                                                {{csrf_field()}}
                                            ...
                                            <div class="form-row mb-4">
                                                <div class="col-7">
                                                    <input name="category" type="text" class="form-control mb-2" id="" value="High-pressure Lines" readonly>
                                                </div>
                                                <div class="col">
                                            ...
                                            <div class="form-row mb-4">
                                                <div class="col">
                                                    <input name="pressure_testing_date" type="text" class="form-control mb-2" id="" placeholder="Pressure Testing Date" required>
                                                </div>
                                            
                                                <div class="col">
                                                    <input name="first_issue_date" type="text" class="form-control mb-2" id="" placeholder="First Issue Date" required>
                                                </div>
                                            </div>
                                            <div class="form-row mb-4">
                                                <div class="col">
                                ...
                                <table id="html5-extension" class="table table-hover non-hover" style="width:100%">
                                    <thead>
                                        <tr>
                                            ...
                                            <th>Pressure Testing Date</th>
                                            <th>First Issued Date</th>
                                            <th>Inspection Date</th>
                                            <th>Inspection Comments</th>
                                            <th>Inspection Carried By</th>
                                            <th>Assessed visual condition (score)</th>
                                            <th>Current location of unit</th>
                                            <th></th>                                                                                      
                                        </tr>
                                    </thead>
                                    <tbody>
                                    @foreach($pressurelines as $log1s)   
                                        <tr>       
                                            ...
                                            <td>{{ $log1s->pressure_testing_date }}</td>
                                            <td>{{ $log1s->first_issue_date }}</td>
                                                ...
                                                <div id="basic" class="col-lg-12 layout-spacing">
                                                    <div class="statbox widget box box-shadow">                                                        
                                                         ...
                                                         <form class="mt-0" action="{{url('/add-pressurelines')}}" method="post">
                                                            ...
                                                            <input name="category" type="hidden" class="form-control mb-2" value="{{ $log1s->category }}" readonly>
                                                            ...
                                                            <input name="pressure_testing_date" type="hidden" class="form-control mb-2" id="" value="{{ $log1s->pressure_testing_date }}" required>

                                                            <input name="first_issue_date" type="hidden" class="form-control mb-2" id="" value="{{ $log1s->first_issue_date }}" required>
                                                        ...
                                                        <div class="modal-footer justify-content-between">
                                                            <button class="btn" data-dismiss="modal"><i class="flaticon-cancel-12"></i> Discard</button>
                                                            <button type="submit" type="button" class="btn btn-primary">Update With New Location</button>
                                                        </div>
                                                    </form>                                                               
                                                    </div>
                                                </div>
