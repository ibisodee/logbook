                                      ...
                                      <div class="modal-dialog" role="document" id="standardModalLabel">
                                        <div class="modal-content">
                                          <div class="modal-body text-center">
                                            ...
                                            @endif
                                            <form class="mt-0" action="{{url('/add-gun')}}" method="post">
                                                {{csrf_field()}}
                                            ...
                                            <div class="form-row mb-4">
                                                <div class="col-7">
                                                    <input name="category" type="text" class="form-control mb-2" id="" value="Hand lance Gun" readonly>
                                                </div>
                                                <div class="col">
                                            ...
                                            <div class="form-row mb-4">
                                                <div class="col">
                                                    <select name="unit_type" class="selectpicker mb-2 ml-2 form-control" data-style="btn btn-outline-primary">
                                                        <option>Select Unit Type</option>
                                                        <option value="Dump Shut Off" >Dump Shut Off</option>
                                                        <option value="Dry Shut Off">Dry Shut Off</option>                                                        
                                                    </select>
                                                </div>                                                
                                            </div>
                                    ...
                                    <div class="modal-content">
                                          <div class="modal-body text-center">
                                            ...
                                            <form class="mt-0" action="{{url('/add-gun')}}" method="post">
                                                ...
                                                <input name="unit_type" type="hidden" class="form-control mb-2" id="" value="{{ $log1s->unit_type }}" required>
                                                ...
                                                <input name="maintenance_completed_date" type="hidden" class="form-control mb-2" id="" value="{{ $log1s->maintenance_completed_date }}" required>

                                                <input  name="inspection_by" class="form-control flatpickr flatpickr-input active" type="hidden" value="{{ $log1s->inspection_by }}">
