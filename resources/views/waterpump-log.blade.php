            ...
            <div class="layout-px-spacing">
                ...
                <div class="row layout-top-spacing" id="cancel-row">
                    ...
                    <div class="widget-content widget-content-area br-6">
                        <h4>• High-pressure water pump units</h4>                
                                      ...
                                      <div class="modal-dialog" role="document" id="standardModalLabel">
                                        <div class="modal-content">
                                          <div class="modal-body text-center">
                                            ...
                                            @endif
                                            <form class="mt-0" action="{{url('/add-waterpump')}}" method="post">
                                                {{csrf_field()}}
                                            ...
                                            <div class="form-row mb-4">
                                                <div class="col-7">
                                                    <input name="category" type="text" class="form-control mb-2" id="" value="High-pressure water pump Units" readonly>
                                                </div>
                                                <div class="col">
                                            ...
                                            <div id="basic" class="col-lg-12 layout-spacing">
                                                    <div class="statbox widget box box-shadow">                                                        
                                                         ...
                                                         <form class="mt-0" action="{{url('/add-waterpump')}}" method="post">
                                                            ...
                                                            <div class="form-row mb-4">
                                                                <div class="col">
                                                                    <input name="inspection_date" type="text" class="form-control mb-2" id="" placeholder="New Inspection Date" required>
                                                                </div>
                                                            </div>
                                                            <div class="form-row mb-4">
                                                                <div class="col">
                                                                    <input name="inspection_comments" type="text" class="form-control mb-2" id="" placeholder="New Inspection Comments" required>
                                                                </div>
                                                            </div>
                                                            <div class="form-row mb-4">
                                                                <div class="col">
                                                                    <input name="inspection_by" type="text" class="form-control mb-2" id="" placeholder="New Inspection By" required>
                                                                </div>
                                                            </div>
                                                            <div class="form-row mb-4">
                                                                <div class="col">
